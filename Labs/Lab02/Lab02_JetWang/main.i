...
void initialize() {
 ...
 gRow0 = (160 / 2) - (gHeight / 2);
 gCol0 = 5;

 gRow1 = (160 / 2) - (gHeight / 2);
 gCol1 = 240 - gWidth - 5;

 gRow2 = 160 - gHeight - 5;
 gCol2 = (240 / 2) - (gWidth / 2);

 gRow3 = 5;
 gCol3 = (240 / 2) - (gWidth / 2);
...
void draw() {
 ...
 drawRect(gCol0, gRow0, gWidth, gHeight, ((0) | (31)<<5 | (0)<<10));
 drawRect(gCol1, gRow1, gWidth, gHeight, ((0) | (31)<<5 | (0)<<10));
 drawRect(gCol2, gRow2, gWidth, gHeight, ((0) | (31)<<5 | (0)<<10));
 drawRect(gCol3, gRow3, gWidth, gHeight, ((0) | (31)<<5 | (0)<<10));
