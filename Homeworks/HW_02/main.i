...
void initialize() {
 ...
 drawRect(targetCol, targetRow, targetSize, targetSize, ((0) | (0)<<5 | (31)<<10));


 drawRect(mineCol, mineRow, mineSize, mineSize, ((31) | (31)<<5 | (0)<<10));
...
void update() {
 ...
 if (bumpCol + bumpWidth - 1 > 240 - 1) {
  bumpOCol = bumpCol;
  bumpCol = (240 - 1) - (bumpWidth - 1);
  bumpVx = 0;
 }
...
void draw() {
 ...
 drawRect(bumpOCol,bumpRow,bumpWidth,bumpHeight, 0);

 drawRect(bumpCol,bumpRow,bumpWidth,bumpHeight, ((31) | (31)<<5 | (31)<<10));

 drawRect(ballOCol, ballORow, ballSize, ballSize, 0);

 drawRect(ballCol,ballRow,ballSize,ballSize, ((31) | (0)<<5 | (0)<<10));
}


void drawFailScreen() {

 drawRect(30,40,5,40,((31) | (0)<<5 | (0)<<10));
 drawRect(35,75,15,5,((31) | (0)<<5 | (0)<<10));
 drawRect(50,40,5,40,((31) | (0)<<5 | (0)<<10));


 drawRect(100,40,5,40,((31) | (0)<<5 | (0)<<10));
 drawRect(105,75,15,5,((31) | (0)<<5 | (0)<<10));


 drawRect(130,40,5,40,((31) | (0)<<5 | (0)<<10));
 drawRect(135,40,15,5,((31) | (0)<<5 | (0)<<10));
 drawRect(135,75,15,5,((31) | (0)<<5 | (0)<<10));
 drawRect(150,40,5,40,((31) | (0)<<5 | (0)<<10));


 drawRect(160,40,20,5,((31) | (0)<<5 | (0)<<10));
 drawRect(160,55,20,5,((31) | (0)<<5 | (0)<<10));
 drawRect(160,75,20,5,((31) | (0)<<5 | (0)<<10));
 drawRect(160,45,5,10,((31) | (0)<<5 | (0)<<10));
 drawRect(175,60,5,15,((31) | (0)<<5 | (0)<<10));


 drawRect(190,40,20,5,((31) | (0)<<5 | (0)<<10));
 drawRect(190,57,20,5,((31) | (0)<<5 | (0)<<10));
 drawRect(190,75,20,5,((31) | (0)<<5 | (0)<<10));
 drawRect(190,45,5,12,((31) | (0)<<5 | (0)<<10));
 drawRect(190,62,5,13,((31) | (0)<<5 | (0)<<10));
}

void drawWinScreen() {

 drawRect(30,40,5,40,((0) | (0)<<5 | (31)<<10));
 drawRect(35,75,15,5,((0) | (0)<<5 | (31)<<10));
 drawRect(50,40,5,40,((0) | (0)<<5 | (31)<<10));


 drawRect(100,40,5,40,((0) | (0)<<5 | (31)<<10));
 drawRect(110,40,5,40,((0) | (0)<<5 | (31)<<10));
 drawRect(120,40,5,40,((0) | (0)<<5 | (31)<<10));
 drawRect(100,75,25,5,((0) | (0)<<5 | (31)<<10));


 drawRect(135,40,5,40,((0) | (0)<<5 | (31)<<10));


 drawRect(150,40,5,40,((0) | (0)<<5 | (31)<<10));
 drawRect(170,40,4,40,((0) | (0)<<5 | (31)<<10));
 drawRect(150,50,5,5,((0) | (0)<<5 | (31)<<10));
 drawRect(155,55,5,5,((0) | (0)<<5 | (31)<<10));
 drawRect(160,60,5,5,((0) | (0)<<5 | (31)<<10));
 drawRect(165,65,5,5,((0) | (0)<<5 | (31)<<10));
}
...
void erase() {
 drawRect(bumpCol,bumpRow,bumpWidth,bumpHeight, 0);
 drawRect(ballCol, ballRow, ballSize, ballSize, 0);
 drawRect(ballOCol, ballORow, ballSize, ballSize, 0);
 drawRect(targetCol, targetRow, targetSize, targetSize, 0);
 drawRect(mineCol, mineRow, mineSize, mineSize, 0);
}
